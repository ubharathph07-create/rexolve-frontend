      ...
      {currentSession.messages.length === 0 && (
        <div style={styles.empty}>
          ...
          <p style={{ marginTop: 8, color: "#555" }}>
            Clear explanations for words, phrases, and concepts.
          </p>

          <div style={styles.examplesBox}>
            <div style={styles.exampleLine}>What does "serendipity" mean?</div>
            <div style={styles.exampleLine}>What does "break the ice" mean?</div>
            <div style={styles.exampleLine}>What is inflation?</div>
            <div style={styles.exampleLine}>What is game theory?</div>
          </div>

          <div style={styles.trustNote}>
            ⚠️ AI explanations may sometimes be incomplete or incorrect.  
            Use this as a quick guide to understand ideas — not as a final authority.
          </div>
        </div>
      )}
